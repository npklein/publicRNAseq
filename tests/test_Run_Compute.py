...
# With the downloaded samples (from test_Download_Samples.py) Gene wants to run the Molgenis pipeline per batch of 2
...
run_compute = genotypePublicData.Run_Compute(molgenis_compute_location,ena_samplesheet,jobs_folder)
